ConvertFrom-StringData @'
    ...
    UnableToDetermineState = The current state cannot be determined because the registry path '{0}' cannot be read.
    FailedToSetDesiredState = Failed to set the desired state for '{0}'. (UAC0011)
'@
