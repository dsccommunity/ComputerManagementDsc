...
- **PSResource**: This resource manages PowerShellGet resources.
...
The resources `PSResourceRepository` and `PSResource` require that the PowerShell modules `PowerShellGet` and `PackageManagement` are already present on the target computer.
