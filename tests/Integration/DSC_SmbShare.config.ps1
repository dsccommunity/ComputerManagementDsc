...
#>
Configuration DSC_SmbShare_Prerequisites_Config
{
...
<#
    .SYNOPSIS
        Create the SMB share with default values, and no permissions.
#>
Configuration DSC_SmbShare_CreateShare2_Config
{
    Import-DscResource -ModuleName 'ComputerManagementDsc'
...
#>
Configuration DSC_SmbShare_UpdateProperties_Config
{
    Import-DscResource -ModuleName 'ComputerManagementDsc'
...
#>
Configuration DSC_SmbShare_RemovePermission_Config
{
    Import-DscResource -ModuleName 'ComputerManagementDsc'
...
#>
Configuration DSC_SmbShare_RecreateShare1_Config
{
    Import-DscResource -ModuleName 'ComputerManagementDsc'
...
<#
    .SYNOPSIS
        Remove the share 1.
#>
Configuration DSC_SmbShare_RemoveShare1_Config
{
    Import-DscResource -ModuleName 'ComputerManagementDsc'
...
<#
    .SYNOPSIS
        Remove the share 2.
#>
Configuration DSC_SmbShare_RemoveShare2_Config
{
    Import-DscResource -ModuleName 'ComputerManagementDsc'
