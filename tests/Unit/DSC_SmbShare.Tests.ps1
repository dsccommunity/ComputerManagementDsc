...
try
{
    InModuleScope $script:dscResourceName {
        ...
        Describe 'DSC_SmbShare\Add-SmbShareAccessPermission' -Tag 'Helper' {
            BeforeAll {
        ...
        Describe 'DSC_SmbShare\Remove-SmbShareAccessPermission' -Tag 'Helper' {
            BeforeAll {
        ...
        Describe 'DSC_SmbShare\Assert-AccessPermissionParameters' -Tag 'Helper' {
