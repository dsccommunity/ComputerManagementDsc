...
try
{
    ...
    InModuleScope 'DSC_VirtualMemory' {
        <#
        ...
        Describe 'DSC_VirtualMemory\Get-TargetResource' {
            BeforeEach {
                $testParameters = @{
                    Drive   = $testDrive
                    Type    = 'CustomSize'
        ...
        Describe 'DSC_VirtualMemory\Set-TargetResource' {
            BeforeEach {
                <#
        ...
        Describe 'DSC_VirtualMemory\Test-TargetResource' {
            ...
            Describe 'DSC_VirtualMemory\Get-PageFileSetting' {
            ...
            Describe 'DSC_VirtualMemory\Set-AutoManagePaging' {
            ...
            Describe 'DSC_VirtualMemory\New-PageFile' {
